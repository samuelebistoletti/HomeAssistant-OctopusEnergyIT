...
> 🎁 Stai scegliendo una nuova wallbox? Approfitta del **10% di sconto** su Trydan o Trydan Pro nello store ufficiale V2C (https://v2charge.com/store/it/) con il codice `INTEGRATIONTRYDAN10`, per maggiori informazioni visita: https://samuele.bistoletti.me/v2c-discount-code/

> 🎁 Se devi attivare un nuovo abbonamento con Octopus Energy puoi usare questo [link](https://octopusenergy.it/octo-friends/airy-queen-959): otterrai **uno sconto fino a 50 €**, per maggiori informazioni visita: https://samuele.bistoletti.me/octopus-energy-referral/
